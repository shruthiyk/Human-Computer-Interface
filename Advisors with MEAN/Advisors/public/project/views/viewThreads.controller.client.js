(function(){
    ...
    function viewThreadController($routeParams, $scope, $http, UserService, ThreadService,RecommendService,$location) {
        var vm = this;
        ...
        function init() {
            ...
            ThreadService
                .findThreadsForcourseCategory(vm.courseCategory)
                .then(
                    function(response){
